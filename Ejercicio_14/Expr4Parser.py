...
class Expr4Parser ( Parser ):
    ...
    class ExprContext(ParserRuleContext):
        ...
        def PLUS(self, i:int=None):
            if i is None:
                return self.getTokens(Expr4Parser.PLUS)
            else:
                return self.getToken(Expr4Parser.PLUS, i)

        def MINUS(self, i:int=None):
            if i is None:
                return self.getTokens(Expr4Parser.MINUS)
            else:
                return self.getToken(Expr4Parser.MINUS, i)
    ...
    class TermContext(ParserRuleContext):
        ...
        def MULT(self, i:int=None):
            if i is None:
                return self.getTokens(Expr4Parser.MULT)
            else:
                return self.getToken(Expr4Parser.MULT, i)
